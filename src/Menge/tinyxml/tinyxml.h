...
class TiXmlNode : public TiXmlBase {
  ...
  */
  ...
  const TiXmlNode* FirstChild(const char* value) const;  ///< The first child of this node with the
                                                         ///matching 'value'. Will be null if none
                                                         ///found.
  /// The first child of this node with the matching 'value'. Will be null if none found.
  TiXmlNode* FirstChild(const char* _value) {
    // Call through to the const version - safe since nothing is changed. Exiting syntax: cast this
    // to a const (always safe)
  ...
  const TiXmlNode* LastChild(const char* value) const;  /// The last child of this node matching
