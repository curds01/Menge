...
class MENGEVIS_API Shape : public GLNode, public Selectable {
 public:
   ...
   *1]).
   *	@param		b		The blue component of the shape's color (in the range [0,
   *1]).
 ...
 protected:
  ...
  /*!
   *	@brief		The shape's OpenGL rendering style.  Should be one of GL_FILL, GL_LINE,
   *				or GL_POINT.
   */
  GLenum _style;
};
...
class MENGEVIS_API Circle : public Shape {
 public:
   ...
   *	@param		b		The blue component of the shape's color (in the range [0,
   *1]).
   *	@param		a		The alpha componet of the shape's color (in the range [0,
   *1]).
...
class MENGEVIS_API Cylinder : public Shape {
 public:
   ...
   *).
   *	@param		style		The draw style of the shape - enumerations consistent with
   *							glPolygonMode are acceptable arguments.
   */
