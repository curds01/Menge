...
class MENGEVIS_API GLViewer {
 public:
   ...
   *1]).
   *	@param		b		The blue component of the background color (must be in the range [0,
   *1]).
   */
 ...
 protected:
  ...
  /*!
   *	@brief		Determines if the viewer should still operate -- as long as it is true, it
   *will
  ...
  /*!
   *	@brief		The current time at which the viewer is running.  Modified by calls to
   *GLViewer::setTime and
   *				GLViewer::offsetTime.
   */
  float _viewTime;
