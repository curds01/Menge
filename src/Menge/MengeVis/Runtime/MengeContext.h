...
/*!
 *	@brief		This context provides the main interface for interaction with the Menge
 *				simulation.  It creates a union of various other contexts: agent,
 *velocity
 *				component, transition (not yet supported), etc.
 */
