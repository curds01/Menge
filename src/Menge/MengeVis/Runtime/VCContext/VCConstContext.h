...
#ifndef __VC_CONST_CONTEXT_H__
#define __VC_CONST_CONTEXT_H__
...
namespace BFSM {
class ConstVelComponent;
class ConstVelDirComponent;
class Goal;
}
}
 ...
 */
class MENGEVIS_API ConstVCContext : public VelCompContext {
 public:
  /*!
 ...
 protected:
  ...
  const Menge::BFSM::ConstVelComponent* _vc;
};
...
*/
class MENGEVIS_API ConstDirVCContext : public VelCompContext {
 public:
  /*!
   *	@brief		Default constructor.
   */
 ...
 protected:
  /*!	@brief		The underlying finite state machine velocity component. */
  const Menge::BFSM::ConstVelDirComponent* _vc;
};
...
*/
class MENGEVIS_API ZeroVCContext : public VelCompContext {
 public:
  /*!
   *	@brief		Constructor.
   */
