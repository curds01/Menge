...
namespace BFSM {
/*!
 @brief		The farthest nav mesh goal selector selects the goal from a goal set that is farthest to
          the agent in terms of path length through the navigation mesh.
 */
