...
class MENGE_API SimulatorDBEntry {
 public:
   ...
   *	@param		behaveFile		The full path to the xml <i>behavior</i>
   *specification.
   ...
   *								trajectories.  If the empty string, no output file
   *will
   *								be written.
   *	@param		scbVersion		The scb version to write.
   *	@param		verbose			Determines if the initialization process prints
   *status
 ...
 protected:
   ...
   *status
   *									and information to the console.  True
   *outputs,
