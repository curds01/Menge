 ...
 *
 *	@param		dir			A vector in R2 describing the direction (from the
 *origin)
 *							of the ray.  (Does not need to be
 *normalized)
 ...
 *	@param		p0			The first vector to interpolate (assumes ||p0|| =
 *1.0.
 *	@param		p1			The first vector to interpolate (assumes ||p1|| =
 *1.0.
