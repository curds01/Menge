...
class MENGE_API ResourceManager {
 public:
   ...
   *different
   *							*types* of resources basedon on the same file resource
   *to
   *							be distinguished.  It is the burden of the programmer
   *to
   *							make sure each type provides a unique suffix,
   *otherwise
   *							problems will arise between suffix
   *collisions.
