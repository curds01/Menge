...
class MENGE_API NavMeshEdge {
 public:
   ...
   *	@param		d		The direction value to set.  It is assumed to be normalized and
   *is
   *						not tested.
   */
   ...
   *				the given radius positioned at pos. "Clear" means a straight-line path
   *will
   *				not cause it to intersect the ends of the edge.

   *	@param		pos			The position of the agent.
   *	@param		radius		The radius of the agent.
   *	@param		param		The parameter, along the edge's direction, of the desired
   *goal
   *							point.
   ...
   *				point along the line of the edge to which the agent with the given
   *radius
   *				can head straight towards and be guaranteed NOT to intersect with the
   *end
   *				points of the edge.  It also leads the agent to get closer to crossing
   *the
   *				edge.
   ...
   *				agent radius and the preferred direction.  If the preferred
   *direction
   *				is collision free, it is returned.  Otherwise, the "best"
   *collision-free
