...
class MENGE_API ProfileSelectorFatalException : public ProfileSelectorException,
 ...
 public:
  ...
  ProfileSelectorFatalException()
      : MengeException(), ProfileSelectorException(), MengeFatalException() {}
  ...
  ProfileSelectorFatalException(const std::string& s)
      : MengeException(s), ProfileSelectorException(), MengeFatalException() {}
};

/*!
 @brief		The base class for agent profile assignment strategies.

 This is an abstract class, primarily defining the mechanism for selecting an agent profile to
 assign to a newly created agent.
 */
class MENGE_API ProfileSelector : public Element {
 ...
 public:
  ...
  /*!
   ...
   Although the ProfileSelector can cache pointers to the profiles for internal convenience, it does
   not own the memory and should not delete them.
