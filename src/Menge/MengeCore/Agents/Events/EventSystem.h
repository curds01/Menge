 ...
 *		- `conservative` determines how the event system handles errors in the declaration
 *of events. If the value is non-null, the system is conservative and any errors in the definition
 *of events are treated as *fatal* errors and the program exits (having written the cause of the
 *problem to the log). If zero, the program will log a *warning*, omit the event, and proceed with
 *simulation.
 */
