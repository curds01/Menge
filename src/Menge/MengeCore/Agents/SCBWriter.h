 ...
 *be
 *						an integer value.
 *					4-byte float x-vPref (the x-component of the agent's pref.
 *velocity).
 *					4-byte float y-vPref (the y-component of the agent's pref.
 *velocity).
 *					4-byte float x-vel (the x-component of the agent's current
 *velocity).
 *					4-byte float y-vel (the y-component of the agent's current
 *velocity).
 */
 ...
 *					4-byte float y-direction - the y-component of the unit
 *vector
 *						pointing in the direction of orientation.
 */
