...
class AgentInitializer : public Menge::Agents::AgentInitializer {
 ...
 protected:
  /*!
   ...
   which derived classes will also benefit from the `<PedVO>` parameter set.
   ...
   */
  virtual Menge::Agents::AgentInitializer::ParseResult processProperty(::std::string propName,
                                                                       TiXmlElement* node);
