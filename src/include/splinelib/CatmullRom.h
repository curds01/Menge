...
void CatmullRomCurve<Vector>::createTangents(bool periodic) {
  ...
  if (periodic) {
    ...
    // initial tangent
    this->_cvs[0]._tangent =
        (this->_cvs[1]._value - this->_cvs[last - 1]._value) /
        (this->_cvs[1]._t - this->_cvs[0]._t + this->_cvs[last]._t - this->_cvs[last - 1]._t);
    ...
    // initial tangent
    this->_cvs[0]._tangent =
        (this->_cvs[1]._value - this->_cvs[0]._value) / (this->_cvs[1]._t - this->_cvs[0]._t);
    ...
    // final tangent
    this->_cvs[last]._tangent = (this->_cvs[last]._value - this->_cvs[last - 1]._value) /
                                (this->_cvs[last]._t - this->_cvs[last - 1]._t);
  }
}
}
