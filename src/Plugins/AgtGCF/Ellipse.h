...
class Ellipse {
 public:
   ...
   *	@param		axes		The semi-major and semi-minor axis values stored in a
   *							two-dimensional vector.
   *	@param		angle		The angle (in radians) defining the orientation of the
   *ellipse.
   */
   ...
   *				ellipse.
   *
   *				Effective distance is the distance between two ellipse boundaries along
   *the
   ...
   *	@param		dir				The direction of minimum displacment is set into
   *this
   *								parameter.
   ...
   *				It is the distance between the center and the line after the obstacle
   *has
   ...
   *				This is computed by finding the intersection of a line formed by the
   *point
   *				and the origin with the ellipse.  The distance is to that point.  This
   *is
   ...
   *	@param		pt		The point used to define the direction.  Should be different
   *from
   *						the ellipse center and, ideally, outside the
   *ellipse.
   ...
   *				necessary to place the ellipse at the center, with its axes aligned
   *with
   *				the world axes.
   ...
   *	@param		pos			The two-dimensional vector specifying center
   *position.
   */
   ...
   *							minor axis sizes in the x and y values,
   *respectively.
   */
